...
from data.data_process_ANP import load_and_preprocess_data
...
def train_mlp(data_dir, channel_options, base_result_dir, mlp_data_type='filtered', neurons=128, num_epochs=15000):
