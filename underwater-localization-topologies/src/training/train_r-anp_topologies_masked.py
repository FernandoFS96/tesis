                ...
                if do_robust_eval:
                    for rfrac in robust_context_fracs:
                        ...
                        r_pred_mean_norm, _, _, _, _ = model(
                            x_seq=x_batch_aug,
                            context_indices=r_ctx_idx,
                            context_y=r_context_y,
                            target_indices=r_tar_idx,
                            target_y=r_target_y,
                            beta=1.0,
                        )
...
def main():
    ...
    # RNN encoder params
    parser.add_argument("--rnn-type", type=str, default="lstm", choices=["lstm", "gru"], help="Type of RNN encoder to use")
    parser.add_argument("--rnn-hidden-dim", type=int, default=128, help="Hidden dimension of the RNN encoder")
