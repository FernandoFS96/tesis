...
- `data/low_variance/channel_option_x.x/filtered_data.npy`
- `data/low_variance/channel_option_x.x/trajectory/trajectories.npy`

- `data/high_variance/channel_option_x.x/filtered_data.npy`
- `data/high_variance/channel_option_x.x/trajectory/trajectories.npy`

Processed data ready to be used to train the models is stored correspondingly in `data/high_variance/data_processed/` or `data/low_variance/data_processed/`  for training and validation. If not present, use script `process_data.py` in `src/preprocessing/` with the following arguments:
...
--data-dir data/old/low_variance/ \
--result-dir results/MLP_2/low_variance \
--theta-range 0.0 0.5 \
--input-dim 4010 \
--output-dim 3
